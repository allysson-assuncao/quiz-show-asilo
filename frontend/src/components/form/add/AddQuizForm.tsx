                                    ...
                                    <FormItem>
                                        ...
                                        <div className="overflow-x-auto rounded-md border mt-2">
                                            <table className="min-w-full divide-y">
                                                <thead className="">
                                                <tr>
                                                    <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Selecionar</th>
                                                    <th className="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Pergunta</th>
                                                </tr>
                                                </thead>
                                                <tbody className="">
                                                {QUESTIONS.map((q) => (
